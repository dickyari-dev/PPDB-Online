...
<head>
    ...
    <meta charset="utf-8" />
    <title>Login | Website PPDB ONLINE</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="Login | Website PPDB ONLINE" name="description" />
    <!-- App favicon -->
        ...
        <div class="container-fluid p-0">
            <div class="card">
                <div class="card-body">
                    ...
                    <h4 class="text-muted text-center font-size-18"><b>Login Page</b></h4>
                    @if (session('success'))
                    <div
                    ...
                    @endif
                    <div class="p-3">
                        <form class="form-horizontal mt-3" action="{{ route('loginPost') }}" method="post">
                            @csrf
