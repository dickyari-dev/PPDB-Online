    ...
    <div class="card-body" style="background-color: #f5f5f5">
        <div class="container my-5 py-5">
            <div class="row">
                ...
                @endif
                <div class="col">
                    <form action="{{ route('student.pendaftaranupdate') }}" method="POST" enctype="multipart/form-data">
                        @csrf
...
<div class="card">
    <div class="card-body" style="background-color: #f5f5f5">
        <div class="container my-5 py-5">
            <div class="row">
                <div class="alert alert-secondary" role="alert">
                    Hallo {{ Auth::user()->name }}, Silahkan Isi Form Dibawah Untuk Melakukan Pendaftaran
                </div>
                <div class="col">
                    <form action="{{ route('student.pendaftaranstore') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-3"><input name="village" placeholder="Desa/Kelurahan"
                                    class="form-control" value="{{ old('village') }}" required></div>
                            <div class="col-md-3"><input name="district" placeholder="Kecamatan" class="form-control"
                        ...
                        <div class="mb-3">
                            <label>Pendapatan Orang Tua</label>
                            <input type="number" name="parent_income" class="form-control"
                                value="{{ old('parent_income') }}" required>
                        </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label>Nama Sekolah</label>
                                <input name="previous_school" class="form-control" value="{{ old('previous_school') }}"
                                    required>
                            </div>
                            <div class="col-md-6">
                                <label>Alamat Sekolah</label>
                                <input name="school_address" class="form-control" value="{{ old('school_address') }}"
                                    required>
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            <label>NPSN Sekolah</label>
                            <input name="school_npsn" class="form-control" value="{{ old('school_npsn') }}" required>
                        </div>
